...
Unlike `old/` (archived data) or `output/` (final output), this folder is for **input** and **work-in-progress**.
...
3. Merge Chain: Run `Merge-CertificateChain.ps1` -> Reads from `new/`, outputs to `output/merged/`
