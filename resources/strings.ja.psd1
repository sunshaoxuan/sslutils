@{
  ...
  "MergeCert.OutFile"                        = "出力ファイル"
  "MergeCert.ChainOutFile"                   = "チェーンファイル"
  ...
  "MakeCsr.InputCnPrompt"                    = "作成する証明書の CN を入力してください。"
  "MakeCsr.InputCnHint"                      = "例: example.com  または  host.example.ac.jp"
  "MakeCsr.PromptCn"                         = "CN"
  "MakeCsr.SubjectInputPrompt"               = "Subject 情報を入力してください。[] 内は既定値です。"
  "MakeCsr.PromptC"                          = "C"
  "MakeCsr.PromptST"                         = "ST"
  "MakeCsr.PromptL"                          = "L"
  "MakeCsr.PromptO"                          = "O"
  "MakeCsr.SanMenuTitle"                     = "SAN 設定"
  "MakeCsr.SanMenuOptionCn"                  = "SAN に CN のみ追加"
  ...
  "ShowModulus.Title"                        = "========== 証明書/秘密鍵 公開鍵一覧 ==========="
  ...
  "ShowModulus.ModulusHash"                  = "公開鍵 (MD5): {0}"
  ...
  "ShowModulus.Advice1"                      = "一致確認は公開鍵の値を比較してください（RSA/ECC 両対応）。"
  "ShowModulus.Advice2"                      = "証明書と秘密鍵は公開鍵が同一ならペアです。"
