@{
  ...
  "Deps.FoundSystem"                         = "[検出] システムに OpenSSL が見つかりました: {0}"
  "Deps.CopyToLocal"                         = "プロジェクトローカルの utils/bin/ にコピーしますか？（ポータブル化）"
  "Deps.CopyPrompt"                          = "ローカルにコピー？ (y/N)"
  "Deps.CopySuccess"                         = "[成功] ローカルにコピーしました: {0}"
  "Deps.CopyFailed"                          = "[失敗] コピーした OpenSSL が正常に動作しません。"
