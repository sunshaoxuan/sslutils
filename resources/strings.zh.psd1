@{
  ...
  "Deps.FoundSystem"                         = "[发现] 系统中已安装 OpenSSL: {0}"
  "Deps.CopyToLocal"                         = "是否将其复制到项目本地 utils/bin/ 目录？（使项目可移植）"
  "Deps.CopyPrompt"                          = "复制到本地？ (y/N)"
  "Deps.CopySuccess"                         = "[成功] 已复制到本地: {0}"
  "Deps.CopyFailed"                          = "[失败] 复制后的 OpenSSL 无法正常运行。"
  ...
  "Deps.DownloadTooSmall"                    = "[警告] 下载文件过小，跳过。"
