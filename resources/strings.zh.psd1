@{
  ...
  "DecryptKey.OutExistsNoOverwrite"          = "输出文件已存在: {0}"
  ...
  "MakeCsr.InputCnPrompt"                    = "请输入要创建证书的 CN。"
  "MakeCsr.InputCnHint"                      = "例如: example.com 或 host.example.ac.jp"
  "MakeCsr.PromptCn"                         = "CN"
  "MakeCsr.SubjectInputPrompt"               = "请输入 Subject 信息。[] 中为默认值。"
  "MakeCsr.PromptC"                          = "C"
  "MakeCsr.PromptST"                         = "ST"
  "MakeCsr.PromptL"                          = "L"
  "MakeCsr.PromptO"                          = "O"
  "MakeCsr.SanMenuTitle"                     = "SAN 设置"
  "MakeCsr.SanMenuOptionCn"                  = "1) SAN 仅添加 CN"
  ...
  "ShowModulus.ModulusHash"                  = "公钥 (MD5): {0}"
  ...
  "ShowModulus.Advice1"                      = "请通过对比公钥值确认是否匹配（支持 RSA 和 ECC）。"
  "ShowModulus.Advice2"                      = "证书与私钥公钥一致则为一对。"
